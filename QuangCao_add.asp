...
<center>
  <table width="780" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#B7B1BF" style="border-left:#333333 1px solid;border-right:#333333 1px solid;">
    <tr>
  	...
  	<tr>
		<td width="690" bgcolor="#333333" height="25px;"><!--#Include file="Template/MenuNgang.asp"-->
    ...
    <tr>
	  ...
	  <%
		...
		Select Case tinhnang
			Case "edit":%>
					<!--#Include file="It_QC_edit.asp"-->
			<%Case "list":%>
					<!--#Include file="It_QC_list.asp"-->
			<%Case "add":%>
					<!--#Include file="It_QC_add.asp"-->
			<%Case else:%>
					<!--#Include file="It_QC_add.asp"-->
		  <%End Select%>	
	  </td>
